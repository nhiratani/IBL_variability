...
from data_loading import extract_hash_eids
...
def process_behav_data(session_type):
    if session_type == 'ephys':
        ...
        # restrict eids to the ones used in the papers
        eids = extract_hash_eids('../data/bdata_ephys')
    ...
    for idx, eid in enumerate(eids):
        ...
        try:
            ...
            if wheel_position is None or wheel_timestamps is None:
                ...
                trials_data['date'] = session_info['auto_datetime']#session_info['date']
